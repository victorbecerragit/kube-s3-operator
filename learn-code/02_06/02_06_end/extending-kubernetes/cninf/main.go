...
import (
	...
	"github.com/fpmoles/extending-kubernetes/cninf/controllers"
...
func init() {
	...
	utilruntime.Must(cninfv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "de1f0625.lil.frankmoley.com",
	})
	if err != nil {
