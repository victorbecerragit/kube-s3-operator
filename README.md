...
- [S3-compatible object storage services](https://docs.sftpgo.com/enterprise/s3-compatible-services/) — MinIO, Ceph,&nbsp;... R2 is Cloudflare's S3-compatible object storage. Wasabi Wasabi is an S3-compatible object storage service.
...
- [💾 Why You Should Consider MinIO Over AWS S3 + How to ...](https://www.reddit.com/r/devops/comments/1kgy054/why_you_should_consider_minio_over_aws_s3_how_to/) — Hello ! I just published a 2-part series exploring object storage and S3 alternatives. ✅ In Part 1, I break down AWS S3 vs MinIO, their pros/cons, ...
<!-- S3_TRENDS_END -->
