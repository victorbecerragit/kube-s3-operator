...
- [S3-compatible object storage services](https://docs.sftpgo.com/enterprise/s3-compatible-services/) — SFTP, FTP, and WebDAV gateway for any S3-compatible object storage. SFTPGo config for Cloudflare R2, Backblaze B2, AIStor, MinIO, Ceph, Wasabi
...
- [Supporting Cloudflare's R2 S3 compatible storage #4480](https://github.com/outline/outline/discussions/4480) — R2 now supports public access which means you can talk to it via the open internet without needing to go through a cloudflare worker. But the bucket name ...
<!-- S3_TRENDS_END -->
